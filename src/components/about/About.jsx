        ...
        <div className='content'>
          <div className='leftpart' data-aos='fade-right' data-aos-duration='1200' data-aos-delay='100'>
            <div className='info'>
              ...
              <p>My interest in front-end engineering started back in 2018 when I developed my first WordPress website. Since then I have built many amazing applications and learned alot in the process. </p>
            </div>
